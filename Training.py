...
training_set = train_datagen.flow_from_directory(f'{path}/Dataset/train', # relative path from working directoy
                                                 target_size = (128, 128),
                                                 batch_size = 6, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory(f'{path}/Dataset/val', # relative path from working directoy
                                             target_size = (128, 128), 
...
# serialize weights to HDF5
    classifier.save_weights("my_model_weights-2.h5")
